        ...
        <div class="card" style="margin-top: 20px">
          <div class="card-header">
            ...
            <button type="button" class="btn btn-primary float-end" data-bs-toggle="modal"
                    data-bs-target="#add-bot-button">创建Bot
            </button>
            <!-- Modal -->
              ...
              <div class="modal-dialog modal-xl">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    <div class="errormessage">{{ botadd.error_message }}</div>
              ...
              <tr v-for="bot in bots" :key="bot.id">
                ...
                <td>
                  <button data-bs-toggle="modal"
                          :data-bs-target="'#update-bot-modal-' + bot.id" type="button"
                          class="btn btn-secondary" style="margin-right: 10px">修改
                  </button>
                  ...
                  <div class="modal fade" :id="'update-bot-modal-' + bot.id" tabindex="-1">
                    <div class="modal-dialog modal-xl">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          <div class="errormessage">{{ bot.error_message }}</div>
...
export default {
  ...
  setup() {
    ...
    const add_bot = () => {
      ...
      $.ajax({
        url: "https://app4453.acapp.acwing.com.cn/api/user/bot/add/",
        type: "post",
        data: {
          title: botadd.title,
    ...
    const remove_bot = (bot) => {
      $.ajax({
        url: "https://app4453.acapp.acwing.com.cn/api/user/bot/remove/",
        type: "post",
        data: {
          bot_id: bot.id
        },
    ...
    const update_bot = (bot) => {
      bot.error_message = "";
      $.ajax({
        url: "https://app4453.acapp.acwing.com.cn/api/user/bot/update/",
        type: "post",
        data: {
          bot_id: bot.id,
          title: bot.title,
